...
SubProceso consultarPeliculasDisponibles()
...
SubProceso alquilarPeliculas(opcion)
...
SubProceso recibirPeliculas(opcion, pelicula)
...
Proceso videoTienda
	...
	Segun opcion Hacer
		...
		3:
			...
			Leer opcion;
			recibirPeliculas(opcion, pelicula);
